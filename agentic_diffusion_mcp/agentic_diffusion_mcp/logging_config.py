"""Logging configuration for agentic-diffusion-mcp MCP server"""
...
def setup_logging(server_config: Optional[ServerConfig] = None) -> None:
    """Configure logging for the agentic-diffusion-mcp MCP server"""
    ...
    project_logger = logging.getLogger("agentic_diffusion_mcp")
    ...
    log_file = log_path / "agentic_diffusion_mcp.log"
...
logger = logging.getLogger("agentic_diffusion_mcp")
