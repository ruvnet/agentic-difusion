"""
Implementation of the AdaptDiffuser model for adaptive diffusion.

This module contains the core AdaptDiffuser model and related components for
task adaptation and reward-guided diffusion processes.
"""
...
# Import from the sub-module to re-export
...
# Add classes needed by the tests
    ...
    def sample(self, shape, task=None, guidance_scale=1.0):
        ...
        for t in timesteps:
            ...
            with torch.no_grad():
                ...
                x = self.noise_scheduler.step(predicted_noise, t, x)
